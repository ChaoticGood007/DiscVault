...
- [ ] Task: Modify the label placement logic to check against the dot coordinate map.
- [ ] Task: Test with dense collections to ensure labels still find valid positions.
- [ ] Task: Conductor - User Manual Verification 'Implementation' (Protocol in workflow.md)

## Phase 3: Final Verification
- [ ] Task: Verify labels no longer overlap dots across different screen sizes.
