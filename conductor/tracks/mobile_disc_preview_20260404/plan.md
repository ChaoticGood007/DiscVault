...
- [ ] Task: Update `DiscPreview.tsx` or `InventoryList.tsx` to trigger the modal on tap/click.
- [ ] Task: Ensure smooth animations using Framer Motion.
- [ ] Task: Conductor - User Manual Verification 'Implementation' (Protocol in workflow.md)

## Phase 3: Final Verification
- [ ] Task: Verify the mobile preview experience on various screen sizes and devices.
