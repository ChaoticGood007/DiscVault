                ...
                >
                  ...
                  {visibleColumns.includes('flight_numbers') && (
                    <>
                      ...
                      <td className="px-6 py-5 text-sm font-black text-center text-slate-900">{useUserFlightNumbers && item.userGlide !== null ? item.userGlide : item.mold.glide}</td>
                      <td className="px-6 py-5 text-sm font-black text-center text-slate-900">{useUserFlightNumbers && item.userTurn !== null ? item.userTurn : item.mold.turn}</td>
                      <td className="px-6 py-5 text-sm font-black text-center text-slate-900">{useUserFlightNumbers && item.userFade !== null ? item.userFade : item.mold.fade}</td>
                    </>
                  )}
